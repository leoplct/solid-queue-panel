...
module SolidQueuePanel
  ...
  class QueueSummary
    attr_reader :name, :ready, :scheduled, :blocked, :in_progress, :failed, :retries, :oldest_enqueued_at, :newest_enqueued_at

    def initialize(name:, ready: 0, scheduled: 0, blocked: 0, in_progress: 0, failed: 0, retries: 0, oldest_enqueued_at: nil, newest_enqueued_at: nil, paused: false)
      @name = name
      @ready = ready
      @scheduled = scheduled
      @blocked = blocked
